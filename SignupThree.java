...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno){
     this.formno = formno;
       ...
       l1.setFont(new Font("Raileway",Font.BOLD,22));
      l1.setBounds(280,40,400,40);
      add(l1);

      JLabel accounttype =new JLabel(" Account Type ");
      accounttype .setFont(new Font("Raileway",Font.BOLD,20));
     ...
     ButtonGroup accoutGroup =new ButtonGroup();
     accoutGroup.add(r1);
     accoutGroup.add(r2);
     accoutGroup.add(r3);
     accoutGroup.add(r4);
     ...
     card.setFont(new Font("Raileway",Font.BOLD,20));
     ...
     cdetail.setFont(new Font("Raileway",Font.BOLD,15));
     cdetail.setBounds(100,330,300,30);
     add(cdetail);


     JLabel pin =new JLabel("PIN:");
     pin.setFont(new Font("Raileway",Font.BOLD,20));
     pin.setBounds(100,370,300,30);
     add(pin);

     JLabel pnum =new JLabel("XXXX");
     pnum.setFont(new Font("Raileway",Font.BOLD,18));
     pnum.setBounds(330,370,300,30);
     add(pnum);

     JLabel cpin =new JLabel("Your 4 Digit pin Number");
     cpin.setFont(new Font("Raileway",Font.BOLD,15));
     cpin.setBounds(100,400,300,30);
     add(cpin);

     
     JLabel services=new JLabel("Services Required:");
     services.setFont(new Font("Raileway",Font.BOLD,20));
   ...
   if (r1.isSelected()) {
    accountType = "Saving Account";}
        ...
        accountType ="Fixied Deposit Account ";
        ...
        accountType ="Reccring Deposit Account";
    
    }
      
    Random random =new Random();
    String cardno ="" + Math.abs((random.nextLong()% 90000000L) + 5040936000000000000L);
    String pinno ="" + Math.abs(random.nextLong()% 90000000L) + 1000L ;
    ...
    if (c1.isSelected()) {
        ...
        facility =facility + " Mobil Banking";  
     }
  ...
  if (accountType.equals("")) {
    JOptionPane.showMessageDialog(null,"Accounnt Type is Requried");
  }else {
    Conn conn =new Conn();
